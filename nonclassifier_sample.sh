...
python3 scripts/classifier_sample_known.py  --data_dir /media/user/ボリューム/brats_imgs_080-128/test  --model_path /mnt/ito/diffusion-anomaly/out/20231027_trained_diffusion_models/brats2update062500.pt --classifier_path /mnt/ito/diffusion-anomaly/out/20231027_trained_classifier_models/modelbratsclass020000.pt --dataset brats --classifier_scale 0 --noise_level 500 $MODEL_FLAGS $DIFFUSION_FLAGS $CLASSIFIER_FLAGS $SAMPLE_FLAGS
