...
python3 scripts/image_valid.py --data_dir /media/user/ボリューム/brats_imgs/train --val_data_dir /media/user/ボリューム/brats_imgs/test  --dataset brats $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
