...
python3 scripts/classifier_valid.py --data_dir /media/user/ボリューム/brats_imgs/train/ --val_data_dir /media/user/ボリューム/brats_imgs/test/ --dataset brats $TRAIN_FLAGS $CLASSIFIER_FLAGS
